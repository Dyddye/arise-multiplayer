...
class ARISE_API UBtlFunctionLibrary : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintCallable)
	static UParticleSystemComponent* SpawnBtlEmitterAtLocation(UObject* WorldContextObject,
	...
	UFUNCTION(BlueprintCallable)
	static ABattleUIManager* GetUIManager();
	...
	UFUNCTION(BlueprintCallable)
	static void BtlPrintString(UObject* WorldContextObject, const FString& inString, bool bPrintToScreen,
	                           bool bPrintToLog,
